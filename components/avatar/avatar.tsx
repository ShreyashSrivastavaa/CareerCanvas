...
import { Message, useSpeech } from "../../hooks/use-speech";

import visemesMapping from "@/constants/avatar/visemes-mapping";
import morphTargets from "@/constants/avatar/morph-targets";
import facialExpressions from "@/constants/avatar/facial-expressions";
...
export function Avatar(props) {
  ...
  const [lipsync, setLipsync] = useState<Message['lipsync'] | undefined>();
