...
>
> Code with Confidence, Design with Brilliance 🚀

Your personal AI mentor for technical interviews and system design
...
CareerCanvas is an AI-powered interview mentor that provides personalized technical interview preparation through interactive 3D avatars, real-time code analysis, and system design visualization. Our platform delivers adaptive learning paths, real-time feedback, and interactive practice sessions to help you excel in your technical interviews.
...
- **Artificial Intelligence**
  ...
  - 🔊 PlayTTS for Text-to-Speech
  - 🎭 Vercel-ai SDK for AI integration

- **3D & Visual Elements**
  - 🎮 Three.js for 3D mentor scenes
  - 📐 Excalidraw-style System Design Visualizer
  - 👄 Rhubarb Lip Sync for avatar animations
...
Developed with ❤️ by **Shreyash Srivastava** & **Prashasti Pathak**.
...
- [Talking Avatar with AI](https://github.com/asanchezyali/talking-avatar-with-ai) - Inspiration for 3D avatar integration
- [Ready Player Me](https://readyplayer.me/) - 3D avatar models and animations
- [Rhubarb Lip Sync](https://github.com/DanielSWolf/rhubarb-lip-sync) - Phoneme detection for lip synchronization
